...
OUT=$(WOW_ROOT="$TMPDIR_FX" CLAUDE_PROJECT_DIR="$TMPDIR_FX" CLAUDE_CONFIG_DIR="$TMPDIR_FX/.claude-empty" WOW_CONSOLIDATE_SCRIPT="$SCRIPT_REAL" bash "$STARTUP" --role senior-developer 2>&1)
