...
# its own auto-inject (not retro-doctrine). Regression guard against the elif
# branches stepping on each other.
# -----------------------------------------------------------------------------
PF=$(mk_project)
...
assert_eq "case-f-story-created-still-emits-2-lines" "2" "$LINES_F"
